...
class SeeAllArtistRadio extends StatefulWidget {
  const SeeAllArtistRadio({Key? key}) : super(key: key);

  @override
  _SeeAllArtistRadioState createState() => _SeeAllArtistRadioState();
}

class _SeeAllArtistRadioState extends State<SeeAllArtistRadio> {
  @override
